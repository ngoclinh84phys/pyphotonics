...
class Photoluminescence_finite_temperature:
    ...
    def __init__(self, path, ground_state, exceited_state, numModes, method, m, resolution, temp=0.0):
        ...
        for i in range(numModes):
            ...
            if temp > 0.0:
                if self.frequencies[i] == 0:
                    ...
                    number_occ_phonon_i = 1.0/(np.exp(self.frequencies[i]/(0.00008617328149741 * temp)) - 1.0)
            else:
                number_occ_phonon_i = 0.0
